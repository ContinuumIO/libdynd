...
struct index_proxy<index_sequence<I...>> {
  ...
  static R make(A &&... a)
  {
    return R(T::template transform<I>(get<I>(std::forward<A>(a)...))...);
  }
#else
  ...
  static R make(A0 &&a0)
  {
    return R(T::template transform<I>(get<I>(std::forward<A0>(a0)))...);
  }
  ...
  static R make(A0 &&a0, A1 &&a1)
  {
    return R(T::template transform<I>(get<I>(std::forward<A0>(a0), std::forward<A1>(a1)))...);
  }
