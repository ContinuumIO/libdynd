...
#ifndef _DYND__ELWISE_CALLREFRES_HPP_
#define _DYND__ELWISE_CALLREFRES_HPP_
...
DYND_PP_JOIN_MAP(CALL_REF_RES_CKERNEL_INSTANTIATOR, (), DYND_PP_RANGE(1, DYND_PP_INC(DYND_ELWISE_MAX)))
...
#endif // _DYND__ELWISE_CALLREFRES_HPP_
