...
#ifndef _DYND__ELWISE_METHREFRES_HPP_
#define _DYND__ELWISE_METHREFRES_HPP_
...
DYND_PP_JOIN_MAP(METH_REF_RES_CKERNEL_INSTANTIATOR, (), DYND_PP_RANGE(1, DYND_PP_INC(DYND_ELWISE_MAX)))
...
DYND_PP_JOIN_MAP(METH_REF_RES, (), DYND_PP_RANGE(1, DYND_PP_INC(DYND_ELWISE_MAX)))

#undef METH_REF_RES

}} // namespace dynd::nd
 
#endif // _DYND__ELWISE_METHREFRES_HPP_
