...
namespace nd {
  namespace functional {
     ...
     *
     * \param child  The arrfunc to be lifted. This must
     *               be a unary operation, which modifies the output in place.
     ...
     */
    arrfunc reduce(const arrfunc &child, const ndt::type &lifted_arr_type,
                   const nd::arrfunc &dst_initialization, bool keepdims,
                   const nd::array &axis, bool associative, bool commutative,
