...
namespace nd {
  namespace detail {
    ...
    template <>
    struct assign_na_kernel<bool_type_id, bool_kind>
        : base_kernel<assign_na_kernel<bool_type_id, bool_kind>,
    ...
    struct assign_na_kernel<DstTypeID, sint_kind>
        : base_kernel<assign_na_kernel<DstTypeID, sint_kind>,
                      kernel_request_host, 0> {
    ...
    template <>
    struct assign_na_kernel<float32_type_id, real_kind>
        : base_kernel<assign_na_kernel<float32_type_id, real_kind>,
                      kernel_request_host, 0> {
      void single(char *dst, char *const *DYND_UNUSED(src))
      {
    ...
    template <>
    struct assign_na_kernel<float64_type_id, real_kind>
        : base_kernel<assign_na_kernel<float64_type_id, real_kind>,
                      kernel_request_host, 0> {
      void single(char *dst, char *const *DYND_UNUSED(src))
      {
    ...
    struct assign_na_kernel<complex_float32_type_id, complex_kind>
        : base_kernel<assign_na_kernel<complex_float32_type_id, complex_kind>,
                      kernel_request_host, 0> {
      void single(char *dst, char *const *DYND_UNUSED(src))
      {
    ...
    struct assign_na_kernel<complex_float64_type_id, complex_kind>
        : base_kernel<assign_na_kernel<complex_float64_type_id, complex_kind>,
                      kernel_request_host, 0> {
      void single(char *dst, char *const *DYND_UNUSED(src))
      {
    ...
    template <>
    struct assign_na_kernel<void_type_id, void_kind>
        : base_kernel<assign_na_kernel<void_type_id, void_kind>,
                      kernel_request_host, 0> {
    ...
    struct assign_na_kernel<fixed_dim_type_id, dim_kind>
          ...
          const std::map<nd::string, ndt::type> &DYND_UNUSED(tp_vars))
      {
        ...
        case bool_type_id:
          assign_na_kernel<bool_type_id, bool_kind>::make(ckb, kernreq,
                                                          ckb_offset);
          return ckb_offset;
        case int8_type_id:
          assign_na_kernel<int8_type_id, sint_kind>::make(ckb, kernreq,
                                                          ckb_offset);
          return ckb_offset;
        case int16_type_id:
          assign_na_kernel<int16_type_id, sint_kind>::make(ckb, kernreq,
                                                           ckb_offset);
          return ckb_offset;
        case int32_type_id:
          assign_na_kernel<int32_type_id, sint_kind>::make(ckb, kernreq,
                                                           ckb_offset);
          return ckb_offset;
        case int64_type_id:
          assign_na_kernel<int64_type_id, sint_kind>::make(ckb, kernreq,
                                                           ckb_offset);
          return ckb_offset;
        case int128_type_id:
          assign_na_kernel<int128_type_id, sint_kind>::make(ckb, kernreq,
                                                            ckb_offset);
          return ckb_offset;
        case float32_type_id:
          assign_na_kernel<float32_type_id, real_kind>::make(ckb, kernreq,
                                                             ckb_offset);
          return ckb_offset;
        case float64_type_id:
          assign_na_kernel<float64_type_id, real_kind>::make(ckb, kernreq,
                                                             ckb_offset);
          return ckb_offset;
        case complex_float32_type_id:
          assign_na_kernel<complex_float32_type_id, complex_kind>::make(
              ckb, kernreq, ckb_offset);
          return ckb_offset;
        case complex_float64_type_id:
          assign_na_kernel<complex_float64_type_id, complex_kind>::make(
              ckb, kernreq, ckb_offset);
          return ckb_offset;
        default:
    ...
    template <>
    struct assign_na_kernel<pointer_type_id, expr_kind>
        : base_kernel<assign_na_kernel<pointer_type_id, expr_kind>,
                      kernel_request_host, 0> {
      void single(char *DYND_UNUSED(dst), char *const *DYND_UNUSED(src))
      {
