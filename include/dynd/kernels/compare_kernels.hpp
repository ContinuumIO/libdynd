...
namespace nd {
  ...
  template <>
  struct fixed_string_less_kernel<string_encoding_utf_8> : base_kernel<fixed_string_less_kernel<string_encoding_utf_8>,
                                                                       2> {
    size_t size;
    ...
    void single(char *dst, char *const *src)
    {
      *reinterpret_cast<bool1 *>(dst) = strncmp(src[0], src[1], size) < 0;
    }
    ...
    {
      make(ckb, kernreq, ckb_offset, src_tp[0].extended<ndt::fixed_string_type>()->get_size());
      return ckb_offset;
    }
  };

  template <>
  struct fixed_string_less_kernel<string_encoding_utf_16> : base_kernel<
                                                                fixed_string_less_kernel<string_encoding_utf_16>, 2> {
    size_t size;
    ...
    void single(char *dst, char *const *src)
    {
      *reinterpret_cast<bool1 *>(dst) = std::lexicographical_compare(
          reinterpret_cast<const uint16_t *>(src[0]), reinterpret_cast<const uint16_t *>(src[0]) + size,
          reinterpret_cast<const uint16_t *>(src[1]), reinterpret_cast<const uint16_t *>(src[1]) + size);
    }
  ...
  template <>
  struct fixed_string_less_kernel<string_encoding_utf_32> : base_kernel<
                                                                fixed_string_less_kernel<string_encoding_utf_32>, 2> {
    size_t size;
    ...
    {
      *reinterpret_cast<bool1 *>(dst) = std::lexicographical_compare(
          reinterpret_cast<const uint32_t *>(src[0]), reinterpret_cast<const uint32_t *>(src[0]) + size,
          reinterpret_cast<const uint32_t *>(src[1]), reinterpret_cast<const uint32_t *>(src[1]) + size);
    }
  ...
  template <>
  struct less_kernel<fixed_string_type_id, fixed_string_type_id> : base_virtual_kernel<less_kernel<
  ...
  template <>
  struct fixed_string_less_equal_kernel<
      string_encoding_utf_8> : base_kernel<fixed_string_less_equal_kernel<string_encoding_utf_8>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_less_equal_kernel<
      string_encoding_utf_16> : base_kernel<fixed_string_less_equal_kernel<string_encoding_utf_16>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_less_equal_kernel<
      string_encoding_utf_32> : base_kernel<fixed_string_less_equal_kernel<string_encoding_utf_32>, 2> {
    size_t size;
  ...
  struct less_equal_kernel<
      ...
      fixed_string_type_id> : base_virtual_kernel<less_equal_kernel<fixed_string_type_id, fixed_string_type_id>> {
    static intptr_t instantiate(char *static_data, size_t data_size, char *data, void *ckb, intptr_t ckb_offset,
                                const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc,
                                const ndt::type *src_tp, const char *const *src_arrmeta, kernel_request_t kernreq,
                                const eval::eval_context *ectx, intptr_t nkwd, const nd::array *kwds,
                                const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      case string_encoding_ascii:
      case string_encoding_utf_8:
        return fixed_string_less_equal_kernel<string_encoding_utf_8>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_16:
        return fixed_string_less_equal_kernel<string_encoding_utf_16>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_32:
        return fixed_string_less_equal_kernel<string_encoding_utf_32>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      default:
        throw std::runtime_error("unidentified string encoding");
  ...
  template <>
  struct fixed_string_equal_kernel<string_encoding_utf_8> : base_kernel<
                                                                fixed_string_equal_kernel<string_encoding_utf_8>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_equal_kernel<string_encoding_utf_16> : base_kernel<
                                                                 fixed_string_equal_kernel<string_encoding_utf_16>, 2> {
    size_t size;
    ...
    static intptr_t
    instantiate(const char *DYND_UNUSED(static_data), size_t DYND_UNUSED(data_size), char *DYND_UNUSED(data), void *ckb,
  ...
  template <>
  struct fixed_string_equal_kernel<string_encoding_utf_32> : base_kernel<
                                                                 fixed_string_equal_kernel<string_encoding_utf_32>, 2> {
    size_t size;
  ...
  template <>
  struct equal_kernel<fixed_string_type_id, fixed_string_type_id> : base_virtual_kernel<equal_kernel<
                                                                        fixed_string_type_id, fixed_string_type_id>> {
    static intptr_t instantiate(char *static_data, size_t data_size, char *data, void *ckb, intptr_t ckb_offset,
                                const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc,
                                const ndt::type *src_tp, const char *const *src_arrmeta, kernel_request_t kernreq,
  ...
  template <>
  struct fixed_string_not_equal_kernel<
      string_encoding_utf_8> : base_kernel<fixed_string_not_equal_kernel<string_encoding_utf_8>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_not_equal_kernel<
      string_encoding_utf_16> : base_kernel<fixed_string_not_equal_kernel<string_encoding_utf_16>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_not_equal_kernel<
      string_encoding_utf_32> : base_kernel<fixed_string_not_equal_kernel<string_encoding_utf_32>, 2> {
    size_t size;
  ...
  struct not_equal_kernel<
      fixed_string_type_id,
      fixed_string_type_id> : base_virtual_kernel<not_equal_kernel<fixed_string_type_id, fixed_string_type_id>> {
    static intptr_t instantiate(char *static_data, size_t data_size, char *data, void *ckb, intptr_t ckb_offset,
                                const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc,
                                const ndt::type *src_tp, const char *const *src_arrmeta, kernel_request_t kernreq,
                                const eval::eval_context *ectx, intptr_t nkwd, const nd::array *kwds,
                                const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      case string_encoding_ascii:
      case string_encoding_utf_8:
        return fixed_string_not_equal_kernel<string_encoding_utf_8>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_16:
        return fixed_string_not_equal_kernel<string_encoding_utf_16>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_32:
        return fixed_string_not_equal_kernel<string_encoding_utf_32>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      default:
        throw std::runtime_error("unidentified string encoding");
  ...
  struct not_equal_kernel<tuple_type_id,
    ...
    static intptr_t instantiate(char *static_data, size_t data_size, char *DYND_UNUSED(data), void *ckb,
  ...
  template <>
  struct fixed_string_greater_equal_kernel<
      string_encoding_utf_8> : base_kernel<fixed_string_greater_equal_kernel<string_encoding_utf_8>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_greater_equal_kernel<
      string_encoding_utf_16> : base_kernel<fixed_string_greater_equal_kernel<string_encoding_utf_16>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_greater_equal_kernel<
      string_encoding_utf_32> : base_kernel<fixed_string_greater_equal_kernel<string_encoding_utf_32>, 2> {
    size_t size;
  ...
  struct greater_equal_kernel<
      fixed_string_type_id,
      fixed_string_type_id> : base_virtual_kernel<greater_equal_kernel<fixed_string_type_id, fixed_string_type_id>> {
    static intptr_t instantiate(char *static_data, size_t data_size, char *data, void *ckb, intptr_t ckb_offset,
                                const ndt::type &dst_tp, const char *dst_arrmeta, intptr_t nsrc,
                                const ndt::type *src_tp, const char *const *src_arrmeta, kernel_request_t kernreq,
                                const eval::eval_context *ectx, intptr_t nkwd, const nd::array *kwds,
                                const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      case string_encoding_ascii:
      case string_encoding_utf_8:
        return fixed_string_greater_equal_kernel<string_encoding_utf_8>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_16:
        return fixed_string_greater_equal_kernel<string_encoding_utf_16>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      case string_encoding_utf_32:
        return fixed_string_greater_equal_kernel<string_encoding_utf_32>::instantiate(
            static_data, data_size, data, ckb, ckb_offset, dst_tp, dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq,
            ectx, nkwd, kwds, tp_vars);
      default:
        throw std::runtime_error("unidentified string encoding");
  ...
  template <>
  struct fixed_string_greater_kernel<
      string_encoding_utf_8> : base_kernel<fixed_string_greater_kernel<string_encoding_utf_8>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_greater_kernel<
      string_encoding_utf_16> : base_kernel<fixed_string_greater_kernel<string_encoding_utf_16>, 2> {
    size_t size;
  ...
  template <>
  struct fixed_string_greater_kernel<
      string_encoding_utf_32> : base_kernel<fixed_string_greater_kernel<string_encoding_utf_32>, 2> {
    size_t size;
