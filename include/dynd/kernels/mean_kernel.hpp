  ...
  struct mean_kernel : base_kernel<mean_kernel, 1> {
                                ...
                                const array *kwds, const std::map<std::string, ndt::type> &tp_vars)
    {
      ...
      ckb_offset = nd::sum::get().get()->instantiate(
          ...
          dst_arrmeta, nsrc, src_tp, src_arrmeta, kernreq, &nd::sum::get().get()->targets, ectx, nkwd, kwds, tp_vars);
      ...
      ckb_offset = nd::compound_div::get().get()->instantiate(
          ...
          ckb_offset, dst_tp, dst_arrmeta, 1, reinterpret_cast<ndt::type *>(static_data), NULL, kernreq,
          &nd::compound_div::get().get()->targets, ectx, nkwd, kwds, tp_vars);
