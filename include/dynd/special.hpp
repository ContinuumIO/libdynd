...
inline double gamma(double x) { return cephes_Gamma(x); }

inline double lgamma(double x) { return cephes_lgam(x); }

inline void airy(double(&res)[2][2], double x) { cephes_airy(x, &res[0][0], &res[0][1], &res[1][0], &res[1][1]); }
...
inline double bessel_j0(double x) { return cephes_j0(x); }

inline double bessel_j1(double x) { return cephes_j1(x); }

inline double bessel_j(double nu, double x) { return cephes_jv(nu, x); }
...
inline double bessel_y0(double x) { return cephes_y0(x); }

inline double bessel_y1(double x) { return cephes_y1(x); }

inline double bessel_y(double nu, double x) { return cephes_yv(nu, x); }

inline double sph_bessel_y0(double x) { return -std::cos(x) / x; }
...
inline complex<double> hankel_h1(double nu, double x) { return complex<double>(bessel_j(nu, x), bessel_y(nu, x)); }
...
inline complex<double> hankel_h2(double nu, double x) { return complex<double>(bessel_j(nu, x), -bessel_y(nu, x)); }
...
inline double struve_h(double nu, double x) { return cephes_struve(nu, x); }
