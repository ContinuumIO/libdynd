 ...
 */
DYND_API void typed_data_copy(const ndt::type &tp, const char *dst_arrmeta, char *dst_data, const char *src_arrmeta,
                              const char *src_data);
 ...
 */
DYND_API void typed_data_assign(const ndt::type &dst_tp, const char *dst_arrmeta, char *dst_data,
                                const nd::array &src_arr, const eval::eval_context *ectx = &eval::default_eval_context);
