...
namespace ndt {
  ...
  public:
    option_type(const type &value_tp, int);
    ...
    {
      return nd::is_avail::get_child(m_value_tp).get();
    }

    const arrfunc_type *get_is_avail_arrfunc_type() const
    {
      return nd::is_avail::get_child(m_value_tp).get_type();
    }

    const arrfunc_type_data *get_assign_na_arrfunc() const
    {
      return nd::assign_na_decl::get_child(m_value_tp).get();
    }

    const arrfunc_type *get_assign_na_arrfunc_type() const
    {
      return nd::assign_na_decl::get_child(m_value_tp).get_type();
    }
  ...
  {
    return option_type::make(make_type<Tnative>());
  }
