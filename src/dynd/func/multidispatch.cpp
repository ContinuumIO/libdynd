                                          ...
                                          const std::vector<arrfunc> &children)
{
  ...
  std::shared_ptr<multidispatch_ck::map_type> map(new multidispatch_ck::map_type);
  ...
  return arrfunc(self_tp, multidispatch_ck::data_type(map, vars),
                 &multidispatch_ck::instantiate,
                 &multidispatch_ck::resolve_option_values,
                 &multidispatch_ck::resolve_dst_type);
}