...
public:
                          ...
                          kernel_request_t kernreq, const eval::eval_context *DYND_UNUSED(ectx)) const
  {
    ...
    if (require_elwise) {
      throw std::runtime_error("data_expr_kernels require elwise_expr_kernels, which are not implemented");
    }
...
public:
                          ...
                          kernel_request_t kernreq, const eval::eval_context *DYND_UNUSED(ectx)) const
  {
    ...
    // giving 'this' as the next kernel generator to call
    if (require_elwise) {
      throw std::runtime_error("date_expr_kernels require elwise_expr_kernels, which are not implemented");
    }
