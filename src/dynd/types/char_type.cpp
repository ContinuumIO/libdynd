...
intptr_t ndt::char_type::make_assignment_kernel(void *ckb, intptr_t ckb_offset, const type &dst_tp,
  ...
  if (this == dst_tp.extended()) {
    ...
    case string_type_id: {
      ...
      return make_fixed_string_to_blockref_string_assignment_kernel(
          ckb, ckb_offset, dst_arrmeta, dst_fs->get_encoding(), get_data_size(), m_encoding, kernreq, ectx);
    }
    default: {
      break;
    }
