...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Bool)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(true)));
  EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(false)));
  EXPECT_FALSE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(1)));
  EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(0)));
  EXPECT_FALSE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(1.0)));
  EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(0.0)));
  EXPECT_FALSE(TestFixture::First::Dereference(ptr_a));
  a.val_assign(TestFixture::Second::To(nd::array(1.5)), &ectx_nocheck);
  EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  /*
    ...
    EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  */
  a.val_assign(TestFixture::Second::To(nd::array(22)), &ectx_nocheck);
  EXPECT_TRUE(TestFixture::First::Dereference(ptr_a));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(2))), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-1))), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1.5))), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1.5)), &ectx_overflow), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1.5)), &ectx_fractional), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1.5)), &ectx_inexact), runtime_error);
  }
}
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Int8)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(-10)));
  EXPECT_EQ(-10, TestFixture::First::Dereference(ptr_i8));
  a.val_assign(TestFixture::Second::To(nd::array(-128)));
  EXPECT_EQ(-128, TestFixture::First::Dereference(ptr_i8));
  a.val_assign(TestFixture::Second::To(nd::array(127)));
  EXPECT_EQ(127, TestFixture::First::Dereference(ptr_i8));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-129))), overflow_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(128))), overflow_error);
  }
  a.val_assign(TestFixture::Second::To(nd::array(5.0)));
  EXPECT_EQ(5, TestFixture::First::Dereference(ptr_i8));
  a.val_assign(TestFixture::Second::To(nd::array(-100.0f)));
  EXPECT_EQ(-100, TestFixture::First::Dereference(ptr_i8));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1.25))), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(128.0))), overflow_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(128.0)), &ectx_inexact), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1e30))), runtime_error);
    a.val_assign(TestFixture::Second::To(nd::array(1.25)), &ectx_overflow);
    EXPECT_EQ(1, TestFixture::First::Dereference(ptr_i8));
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-129.0)), &ectx_overflow), overflow_error);
  }
  a.val_assign(TestFixture::Second::To(nd::array(1.25)), &ectx_nocheck);
  EXPECT_EQ(1, TestFixture::First::Dereference(ptr_i8));
  a.val_assign(TestFixture::Second::To(nd::array(-129.0)), &ectx_nocheck);
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_UInt16)
{
  ...
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-1))), overflow_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-1)), &ectx_overflow), overflow_error);
  }
  a.val_assign(TestFixture::Second::To(nd::array(-1)), &ectx_nocheck);
  EXPECT_EQ(65535, TestFixture::First::Dereference(ptr_u16));
  a.val_assign(TestFixture::Second::To(nd::array(1234)));
  EXPECT_EQ(1234, TestFixture::First::Dereference(ptr_u16));
  a.val_assign(TestFixture::Second::To(nd::array(65535.0f)));
  EXPECT_EQ(65535, TestFixture::First::Dereference(ptr_u16));
}
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Float32)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array((char)30)));
  EXPECT_EQ(30, TestFixture::First::Dereference(ptr_f32));
  a.val_assign(TestFixture::Second::To(nd::array((uint16_t)58000)));
  EXPECT_EQ(58000, TestFixture::First::Dereference(ptr_f32));
  a.val_assign(TestFixture::Second::To(nd::array(1.25)));
  EXPECT_EQ(1.25, TestFixture::First::Dereference(ptr_f32));
  a.val_assign(TestFixture::Second::To(nd::array(1 / 3.0)));
  EXPECT_EQ((float)(1 / 3.0), TestFixture::First::Dereference(ptr_f32));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1 / 3.0)), &ectx_inexact), runtime_error);
  }
  // Float32 can't represent this value exactly
  a.val_assign(TestFixture::Second::To(nd::array(33554433)));
  EXPECT_EQ(33554432, TestFixture::First::Dereference(ptr_f32));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(33554433)), &ectx_inexact), runtime_error);
  }
}
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Float64)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(1 / 3.0f)));
  EXPECT_EQ(1 / 3.0f, TestFixture::First::Dereference(ptr_f64));
  a.val_assign(TestFixture::Second::To(nd::array(1 / 3.0)));
  EXPECT_EQ(1 / 3.0, TestFixture::First::Dereference(ptr_f64));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    a.val_assign(TestFixture::Second::To(nd::array(33554433)), &ectx_inexact);
    EXPECT_EQ(33554433, TestFixture::First::Dereference(ptr_f64));
  }
  // Float64 can't represent this integer value exactly
  a.val_assign(TestFixture::Second::To(nd::array(36028797018963969LL)));
  EXPECT_EQ(36028797018963968LL, TestFixture::First::Dereference(ptr_f64));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(36028797018963969LL)), &ectx_inexact), runtime_error);
  }
}
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Uint64)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(1.0e10f)));
  EXPECT_EQ(10000000000ULL, TestFixture::First::Dereference(ptr_u64));
  a.val_assign(TestFixture::Second::To(nd::array(2.0e10)));
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Uint64_LargeNumbers)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(13835058055282163712.f)));
  EXPECT_EQ(13835058055282163712ULL, TestFixture::First::Dereference(ptr_u64));
  a.val_assign(TestFixture::Second::To(nd::array(16140901064495857664.0)));
  EXPECT_EQ(16140901064495857664ULL, TestFixture::First::Dereference(ptr_u64));
  a.val_assign(TestFixture::Second::To(nd::array(13835058055282163712.f)), &ectx_nocheck);
  EXPECT_EQ(13835058055282163712ULL, TestFixture::First::Dereference(ptr_u64));
  a.val_assign(TestFixture::Second::To(nd::array(16140901064495857664.0)), &ectx_nocheck);
  EXPECT_EQ(16140901064495857664ULL, TestFixture::First::Dereference(ptr_u64));
}
#endif
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Complex_Float32)
{
  ...
  a.val_assign(TestFixture::Second::To(nd::array(dynd::complex<float>(1.5f, 2.75f))));
  EXPECT_EQ(dynd::complex<float>(1.5f, 2.75f), TestFixture::First::Dereference(ptr_cf32));
  a.val_assign(TestFixture::Second::To(nd::array(dynd::complex<double>(1 / 3.0, -1 / 7.0))));
  EXPECT_EQ(dynd::complex<float>(float(1 / 3.0), float(-1 / 7.0)), TestFixture::First::Dereference(ptr_cf32));
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(dynd::complex<double>(1 / 3.0, -1 / 7.0))), &ectx_inexact),
                 runtime_error);
  }
}
...
TYPED_TEST_P(ArrayAssign, ScalarAssignment_Complex_Float64)
{
  ...
  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    a.val_assign(TestFixture::Second::To(nd::array(dynd::complex<double>(1 / 3.0, -1 / 7.0))), &ectx_inexact);
...
TYPED_TEST_P(ArrayAssign, BroadcastAssign)
{
  ...
  int v0[4] = {3, 4, 5, 6};
  nd::array b = TestFixture::Second::To(nd::array(v0));
  ...
  b = TestFixture::Second::To(nd::array(v1));
  ...
  b = TestFixture::Second::To(nd::array(v2));
...
{
  int v0[4] = {0, 1, 2, 3};
  nd::array a = TestFixture::First::To(nd::array(v0));
  eval::eval_context ectx_overflow;
  ectx_overflow.errmode = assign_error_overflow;

  if (!TestFixture::First::IsTypeID(cuda_device_type_id) && !TestFixture::Second::IsTypeID(cuda_device_type_id)) {
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1e25)), &ectx_overflow), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(1e25f)), &ectx_overflow), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-1e25)), &ectx_overflow), runtime_error);
    EXPECT_THROW(a.val_assign(TestFixture::Second::To(nd::array(-1e25f)), &ectx_overflow), runtime_error);
  }
}
