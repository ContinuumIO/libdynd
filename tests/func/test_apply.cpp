...
TEST(Apply, Function)
{
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(4)), af(TestFixture::To(nd::array(5)), TestFixture::To(nd::array(3))));

  af = nd::functional::apply<kernel_request_host, decltype(&func2), &func2>();
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(13.6f)),
                af(TestFixture::To(nd::array({3.9f, -7.0f, 16.7f}))));

  af = nd::functional::apply<kernel_request_host, decltype(&func3), &func3>();
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(12U)), af());
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(8)),
                af(TestFixture::To(nd::array(3)), TestFixture::To(nd::array(5)), TestFixture::To(nd::array(7))));

  af = nd::functional::apply<kernel_request_host, decltype(&func7), &func7>();
  EXPECT_ARRAY_EQ(
      TestFixture::To(nd::array(36.3)),
      af(TestFixture::To(nd::array(38)), TestFixture::To(nd::array(5)), TestFixture::To(nd::array(12.1))));
}
...
TEST(Apply, FunctionWithKeywords)
{
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(4)),
                af(TestFixture::To(nd::array(5)), kwds("y", TestFixture::To(nd::array(3)))));

  af = nd::functional::apply<decltype(&func0), &func0>("x", "y");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(4)),
                af(kwds("x", TestFixture::To(nd::array(5)), "y", TestFixture::To(nd::array(3)))));

  af = nd::functional::apply<decltype(&func6), &func6>("z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(8)), af(TestFixture::To(nd::array(3)), TestFixture::To(nd::array(5)),
                                       kwds("z", TestFixture::To(nd::array(7)))));

  af = nd::functional::apply<decltype(&func6), &func6>("y", "z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(8)),
                af(TestFixture::To(nd::array(3)),
                   kwds("y", TestFixture::To(nd::array(5)), "z", TestFixture::To(nd::array(7)))));

  af = nd::functional::apply<decltype(&func6), &func6>("x", "y", "z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(8)),
                af(kwds("x", TestFixture::To(nd::array(3)), "y", TestFixture::To(nd::array(5)), "z",
                        TestFixture::To(nd::array(7)))));

  af = nd::functional::apply<decltype(&func7), &func7>("z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(36.3)),
                af(TestFixture::To(nd::array(38)), TestFixture::To(nd::array(5)),
                   kwds("z", TestFixture::To(nd::array(12.1)))));

  af = nd::functional::apply<decltype(&func7), &func7>("y", "z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(36.3)),
                af(TestFixture::To(nd::array(38)),
                   kwds("y", TestFixture::To(nd::array(5)), "z", TestFixture::To(nd::array(12.1)))));

  af = nd::functional::apply<decltype(&func7), &func7>("x", "y", "z");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(36.3)),
                af(kwds("x", TestFixture::To(nd::array(38)), "y", TestFixture::To(nd::array(5)), "z",
                        TestFixture::To(nd::array(12.1)))));
}
...
TEST(Apply, MemberFunction)
{
  ...
  EXPECT_ARRAY_EQ(nd::array(7), af(nd::array(1), nd::array(2), nd::array(3)));
...
TYPED_TEST_P(Apply, Callable)
{
  ...
  if (TestFixture::KernelRequest == kernel_request_host) {
    ...
    EXPECT_ARRAY_EQ(TestFixture::To(nd::array(4)),
                  af(TestFixture::To(nd::array(5)), TestFixture::To(nd::array(3))));
  ...
  if (TestFixture::KernelRequest == kernel_request_cuda_device) {
    ...
    EXPECT_ARRAY_EQ(TestFixture::To(nd::array(58.25)),
                  af(TestFixture::To(nd::array(3.25)), TestFixture::To(nd::array(20))));
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(167.451)),
                af(TestFixture::To(nd::array({9.25, -2.7, 15.375})),
                   TestFixture::To(nd::array({0.0, 0.62, 11.0}))));
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(475.0)), af(TestFixture::To(nd::array(47.5))));
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(11)),
                af(TestFixture::To(nd::array(5)), TestFixture::To(nd::array(3))));
...
TYPED_TEST_P(Apply, CallableWithKeywords)
{
  ...
  if (TestFixture::KernelRequest == kernel_request_host) {
    ...
    EXPECT_ARRAY_EQ(TestFixture::To(nd::array(4)), af(nd::array(5), kwds("y", TestFixture::To(nd::array(3)))));
  ...
  if (TestFixture::KernelRequest == kernel_request_cuda_device) {
    ...
    EXPECT_ARRAY_EQ(TestFixture::To(nd::array(58.25)),
                  af(TestFixture::To(nd::array(3.25)), kwds("y", TestFixture::To(nd::array(20)))));

    af = nd::functional::apply<kernel_request_cuda_device>(
        get_func1<kernel_request_cuda_device>(), "x", "y");
    EXPECT_ARRAY_EQ(TestFixture::To(nd::array(58.25)), af(kwds("x", TestFixture::To(nd::array(3.25)),
                                                  "y", TestFixture::To(nd::array(20)))));
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(475.0)), af(kwds("x", TestFixture::To(nd::array(47.5)))));

  af = nd::functional::apply<TestFixture::KernelRequest,
                             callable1<TestFixture::KernelRequest>, int, int>(
      "x", "y");
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(28)),
                af(TestFixture::To(nd::array(2)),
                   kwds("x", TestFixture::To(nd::array(1)), "y", TestFixture::To(nd::array(7)))));
  ...
  EXPECT_ARRAY_EQ(TestFixture::To(nd::array(8)), af(TestFixture::To(nd::array(5)), TestFixture::To(nd::array(3)),
                                       kwds("z", TestFixture::To(nd::array(4)))));
}
