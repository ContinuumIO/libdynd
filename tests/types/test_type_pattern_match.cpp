...
TEST(TypePatternMatch, Simple)
{
  ...
  EXPECT_TRUE(ndt::type("4 * int32").matches(ndt::type("A... * 4 * M")));
  EXPECT_TRUE(ndt::type("3 * int32").matches(ndt::type("3 * A... * M")));
  EXPECT_TRUE(
      ndt::type("Fixed**3 * int32").matches(ndt::type("Fixed**N * int32")));
  EXPECT_TRUE(ndt::type("Fixed**2 * var * int32")
                  .matches(ndt::type("A**N * var * int32")));
  EXPECT_TRUE(
      ndt::type("Fixed * int32").matches(ndt::type("Fixed**N * int32")));
  EXPECT_TRUE(
      ndt::type("4 * 4 * 3 * int32").matches(ndt::type("4**N * 3 * int32")));
  EXPECT_TRUE(
      ndt::type("4 * 4 * 2 * int32").matches(ndt::type("4**N * M * int32")));
  EXPECT_TRUE(
      ndt::type("4 * 4 * 2 * int32").matches(ndt::type("4**N * N * int32")));
...
TEST(TypePatternMatch, Any)
{
  ...
  EXPECT_TRUE(ndt::type("int32").matches(ndt::type("Any")));
  EXPECT_TRUE(ndt::type("(float32, Any)").matches(ndt::type("Any")));
  ...
  EXPECT_TRUE(ndt::type("2 * 3 * complex[float32]").matches(ndt::type("Any")));
  EXPECT_TRUE(ndt::type("3 * {x: 2 * int32, y: var * int16}")
                  .matches(ndt::type("Any")));
  EXPECT_TRUE(ndt::type("3 * 5 * var * (int32, float16, 2 * int8)")
                  .matches(ndt::type("Any")));
}
...
TEST(TypePatternMatch, VariadicTuple)
{
  ...
  EXPECT_TRUE(ndt::type("(int32)").matches(ndt::type("(...)")));
  EXPECT_FALSE(ndt::type("(int32, ...)").matches(ndt::type("(int32)")));
  EXPECT_TRUE(ndt::type("(int32, int64)").matches(ndt::type("(...)")));
  EXPECT_TRUE(ndt::type("(int32, int64, float32)").matches(ndt::type("(...)")));
  EXPECT_TRUE(
      ndt::type("(int32, int64, float32)").matches(ndt::type("(int32, ...)")));
  EXPECT_TRUE(ndt::type("(int32, int64, float32)")
                  .matches(ndt::type("(int32, int64, ...)")));
  EXPECT_TRUE(ndt::type("(int32, int64, float32)")
                  .matches(ndt::type("(int32, int64, float32, ...)")));
  EXPECT_TRUE(ndt::type("(int32, int64, float32)")
                  .matches(ndt::type("(int32, T, ...)")));
  EXPECT_FALSE(
      ndt::type("(int32, int64, float32)").matches(ndt::type("(T, T, ...)")));
  EXPECT_TRUE(
      ndt::type("(int32, int32, float32)").matches(ndt::type("(T, T, ...)")));
}
...
TEST(TypePatternMatch, Struct)
{
  ...
  EXPECT_TRUE(ndt::type("100 * {x: int32, y: int32}")
                  .matches(ndt::type("A... * {x: T, y: T}")));
  EXPECT_TRUE(ndt::type("100 * {x: int32, y: int32, u: int16, v: int16}")
...
TEST(TypePatternMatch, ArrFuncProto)
{
  ...
  EXPECT_TRUE(ndt::type("(int32, 5 * var * 2 * int16) -> float32")
                  .matches(ndt::type("(S, A... * 2 * int16) -> T")));
...
TEST(TypePatternMatch, VariadicArrFuncProto)
{
  ...
  EXPECT_TRUE(
      ndt::type(
          ...
          .matches(ndt::type("(Fixed**N * T, ..., func: (N * T) -> R) -> R")));
}
...
TEST(TypePatternMatch, Pow)
{
  ...
  EXPECT_TRUE(ndt::type("Fixed * Fixed * Fixed * int32")
                  .matches(ndt::type("D * D**N * int32")));
  EXPECT_TRUE(
